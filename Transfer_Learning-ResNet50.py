...
def get_model_name(k):
    return 'ResNet50Amiloidosis_'+str(k)+'.h5'
...
for train_index, val_index in skf.split(np.zeros(len(Y)), Y):
    ...
    # rótulos 2D codificados, graças ao "binary". Ele tira as fotos de ordem.
    ...
    plt.title('ResNet50')
    plt.legend(loc='best')
    figname='ResNet50-ROC'+str(fold_var)+'.png'
    plt.savefig(figname)
    plt.clf()
